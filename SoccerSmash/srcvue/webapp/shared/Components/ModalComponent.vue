<template>
  ...
  <div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
    ...
    <div class="modal-container fixed w-full h-full z-50 overflow-y-auto flex flex-col justify-center">
      ...
      <div class="modal-content container mx-auto h-auto text-left p-4">
        ...
        <div class="flex justify-end pt-2" v-if="showFooter">
          <button class="px-4 bg-transparent p-3 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2">Save</button>
...
class ModalComponent extends Vue {
  @Prop({
    type:Boolean,
    default: true
  }) public readonly showFooter : boolean;
}
</script>
<style>
.modal {
